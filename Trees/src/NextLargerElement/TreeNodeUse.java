...
{
   TreeNode<Integer> ans= NextLargerElement(root.Children.get(i), n);
   if(ans!=null)
   {if(finalans==null)
    {
    finalans=ans;
...
if(root.data>n&&finalans==null)
{
    return root;
}
if(root.data>n&&root.data<finalans.data)
{
return root;
}
return finalans;
...
System.out.print(t1.Children.get(i).data+" ");
 ...
 i++;
    ...
    { Scanner s = new Scanner(System.in);
        ...
        // print(root);
        TreeNode<Integer> ans=NextLargerElement(root,n);
